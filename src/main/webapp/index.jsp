            ...
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">客流量监测系统</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                ...
                <li>
                    <a class="J_menuItem" href="index_v1.html">
                        ...
                        <span class="nav-label">实时客流量</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="graph_echarts.html">
                        <i class="fa fa-home"></i>
                        <span class="nav-label">客流量展示</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="picture.html">摄像头1</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_flot.html">摄像头2</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_morris.html">摄像头3</a>
                        </li>
                    </ul>
                </li>
